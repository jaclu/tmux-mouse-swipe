...
#
tmux  bind-key -N "(tmux-mouse-swipe) Swipe initiated" -n MouseDrag3Pane    run "$swipe_script down '#{mouse_x}' '#{mouse_y}'"
tmux bind-key  -N "(tmux-mouse-swipe) Swiping ended"   -n MouseDragEnd3Pane run "$swipe_script up   '#{mouse_x}' '#{mouse_y}'"
